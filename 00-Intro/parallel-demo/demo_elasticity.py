...
with XDMFFile(mesh.mpi_comm(), "output/stress.xdmf") as file:
    file.write(stress)

with XDMFFile(mesh.mpi_comm(), "output/partitions.xdmf") as file:
    mf = MeshFunction("size_t", mesh, mesh.topology().dim(),  MPI.rank(mesh.mpi_comm()))
    file.write(mf)